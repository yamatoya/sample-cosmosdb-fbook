...
本資料は、MicrosoftのCosmosDBチームのGithubで公開されている[CosmosDB-DataModeling.pptx](https://github.com/AzureCosmosDB/content/tree/master/decks)と、アメリカで開催されたセミナーの内容をもとに書き起こし＆意訳＆追記したものになります。
